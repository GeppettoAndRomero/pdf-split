...
export const ui = {
  en: {
    ...
    uploadSubtitle: 'Choose a PDF to split.',
    dropClick: 'Click to choose files',
    dropOr: 'or drop files anywhere on the page',
    dropSupported: 'PDF files',
    settingsButton: 'Settings',
    pagesLabel: 'pages', rangeLabel: 'Pages to extract', extractButton: 'Extract pages', extracting: 'Extracting…',
    selectAllPages: 'Select all', invertSelection: 'Invert', clearSelection: 'Clear',
    previewsAria: 'Page previews', pageAria: 'Page {n}',
    loadingPreviews: 'Rendering page previews…',
    errNoPages: 'Select at least one page to extract.',
    ...
    errRangeEmpty: 'Enter the pages to extract (e.g. 1-3, 5).',
    errRangeInvalid: '"{token}" is not a valid page or range.',
    errPageOutOfRange: 'Pages must be between 1 and {n}.',
    errNoPagesSelected: 'No pages selected.',
    ...
    dzDropSub: 'Drop a PDF to split its pages',
  ...
  ja: {
    ...
    uploadSubtitle: '分割したい PDF を選んでください。',
    dropClick: 'クリックして選択',
    dropOr: 'またはページ上にドロップ',
    dropSupported: 'PDF ファイル',
    settingsButton: '設定',
    pagesLabel: 'ページ', rangeLabel: '抽出するページ', extractButton: 'ページを抽出', extracting: '抽出中…',
    selectAllPages: 'すべて選択', invertSelection: '選択を反転', clearSelection: 'クリア',
    previewsAria: 'ページのプレビュー', pageAria: '{n} ページ目',
    loadingPreviews: 'ページのプレビューを生成中…',
    errNoPages: '抽出するページを 1 つ以上選んでください。',
    ...
    errRangeEmpty: '抽出するページを入力してください（例: 1-3, 5）。',
    errRangeInvalid: '「{token}」は有効なページまたは範囲ではありません。',
    errPageOutOfRange: 'ページは 1 から {n} の間で指定してください。',
    errNoPagesSelected: 'ページが選択されていません。',
  ...
  zh: {
    // ConversionManager
    uploadHeading: '选择文件',
    uploadSubtitle: '选择要拆分的 PDF。',
    dropClick: '点击选择文件',
    dropOr: '或把文件拖到页面任意位置',
    dropSupported: 'PDF 文件',
    settingsButton: '设置',
    pagesLabel: '页', rangeLabel: '要提取的页面', extractButton: '提取页面', extracting: '正在提取…',
    selectAllPages: '全选', invertSelection: '反选', clearSelection: '清除',
    previewsAria: '页面预览', pageAria: '第 {n} 页',
    loadingPreviews: '正在生成页面预览…',
    errNoPages: '请至少选择一页进行提取。',
    ...
    errRangeEmpty: '请输入要提取的页码（例如 1-3, 5）。',
    errRangeInvalid: '“{token}” 不是有效的页码或范围。',
    errPageOutOfRange: '页码必须在 1 到 {n} 之间。',
    errNoPagesSelected: '未选择任何页面。',
  ...
  de: {
    ...
    uploadSubtitle: 'Wähle ein PDF zum Teilen.',
    dropClick: 'Zum Auswählen klicken',
    dropOr: 'oder Dateien irgendwo auf die Seite ziehen',
    dropSupported: 'PDF-Dateien',
    settingsButton: 'Einstellungen',
    pagesLabel: 'Seiten', rangeLabel: 'Zu extrahierende Seiten', extractButton: 'Seiten extrahieren', extracting: 'Wird extrahiert…',
    selectAllPages: 'Alle auswählen', invertSelection: 'Umkehren', clearSelection: 'Leeren',
    previewsAria: 'Seitenvorschau', pageAria: 'Seite {n}',
    loadingPreviews: 'Seitenvorschau wird erstellt …',
    errNoPages: 'Wähle mindestens eine Seite zum Extrahieren aus.',
    ...
    errRangeEmpty: 'Gib die zu extrahierenden Seiten ein (z. B. 1-3, 5).',
    errRangeInvalid: '„{token}" ist keine gültige Seite oder kein gültiger Bereich.',
    errPageOutOfRange: 'Seiten müssen zwischen 1 und {n} liegen.',
    errNoPagesSelected: 'Keine Seiten ausgewählt.',
    ...
    dzDropSub: 'Lege ein PDF ab, um Seiten zu teilen',
  ...
  es: {
    ...
    uploadSubtitle: 'Elige un PDF para dividir.',
    ...
    pagesLabel: 'páginas', rangeLabel: 'Páginas a extraer', extractButton: 'Extraer páginas', extracting: 'Extrayendo…',
    selectAllPages: 'Seleccionar todo', invertSelection: 'Invertir', clearSelection: 'Limpiar',
    previewsAria: 'Vista previa de páginas', pageAria: 'Página {n}',
    loadingPreviews: 'Generando vistas previas de las páginas…',
    errNoPages: 'Selecciona al menos una página para extraer.',
    ...
    errRangeEmpty: 'Introduce las páginas que quieres extraer (por ejemplo, 1-3, 5).',
    errRangeInvalid: '«{token}» no es una página o un intervalo válido.',
    errPageOutOfRange: 'Las páginas deben estar entre 1 y {n}.',
    errNoPagesSelected: 'No se ha seleccionado ninguna página.',
    ...
    dzDropSub: 'Suelta un PDF para dividir sus páginas',
